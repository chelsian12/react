...
/* build-hook-start *//*00001*/try { require('c:\\users\\dilip\\.vscode\\extensions\\wallabyjs.console-ninja-0.0.201\\out\\buildhook\\index.js').default({tool: 'webpack'}); } catch(cjsError) { try { import('file:///c:/users/dilip/.vscode/extensions/wallabyjs.console-ninja-0.0.201/out/buildhook/index.js').then(m => m.default.default({tool: 'webpack'})).catch(esmError => {}) } catch(esmError) {}}/* build-hook-end */
/*
